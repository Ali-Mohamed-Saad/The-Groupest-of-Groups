    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                setToast({ show: true, message: err.error || 'Failed to save', type: 'danger' });
            } else {
                setToast({ show: true, message: 'Profile updated successfully!', type: 'success' });
            }
        } catch (err) {
            setToast({ show: true, message: 'Network error', type: 'danger' });
        } finally {
            ...
            <form onSubmit={handleSave}>
                ...
                <div className="row">
                    <div className="col-md-6 settings-form-group">
                        ...
                        <input id="prof-first" type="text" className="settings-input"
                            value={profile.firstName} onChange={handleChange("firstName")} />
                    </div>
                    <div className="col-md-6 settings-form-group">
                        <label className="settings-label" htmlFor="prof-last">Last Name</label>
                        <input id="prof-last" type="text" className="settings-input"
                            value={profile.lastName} onChange={handleChange("lastName")} />
                    </div>
                </div>

                <div className="settings-form-group">
                    <label className="settings-label" htmlFor="prof-bio">Bio</label>
                    <textarea id="prof-bio" className="settings-textarea"
                ...
                <div className="row">
                    <div className="col-md-6 settings-form-group">
                        ...
                        <input id="prof-title" type="text" className="settings-input"
                            placeholder="e.g. Frontend Developer"
                            value={profile.jobTitle} onChange={handleChange("jobTitle")} />
                    </div>
                    <div className="col-md-6 settings-form-group">
                        <label className="settings-label" htmlFor="prof-dept">Department</label>
                        <input id="prof-dept" type="text" className="settings-input"
                            placeholder="e.g. Engineering"
                            value={profile.department} onChange={handleChange("department")} />
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-md-6 settings-form-group">
                        ...
                        <input id="prof-phone" type="tel" className="settings-input"
                            placeholder="+20 100 000 0000"
                            value={profile.phone} onChange={handleChange("phone")} />
                    </div>
                    <div className="col-md-6 settings-form-group">
                        <label className="settings-label" htmlFor="prof-location">Location</label>
                        <input id="prof-location" type="text" className="settings-input"
                            placeholder="e.g. Cairo, Egypt"
                            value={profile.location} onChange={handleChange("location")} />
                    </div>
                </div>
                ...
                <div className="settings-form-group">
                    ...
                    <input id="prof-github" type="url" className="settings-input"
                ...
                <div className="settings-form-group">
                    ...
                    <input id="prof-linkedin" type="url" className="settings-input"
                ...
                <div className="settings-form-group">
                    ...
                    <input id="prof-twitter" type="url" className="settings-input"
                        placeholder="https://twitter.com/username"
                        value={profile.twitter} onChange={handleChange("twitter")} />
                </div>
